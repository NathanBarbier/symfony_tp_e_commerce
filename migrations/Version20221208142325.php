 ...
 */
final class Version20221208142325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier ADD panier_id INT NOT NULL, ADD quantite INT NOT NULL, ADD date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier DROP panier_id, DROP quantite, DROP date');
    }
}
